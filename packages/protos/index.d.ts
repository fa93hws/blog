...
export namespace PostProto {
    ...
    class Post implements IPost {
         ...
         * @param [properties] Properties to set
         */
        constructor(properties?: PostProto.IPost);
         ...
         */
        public static create(properties?: PostProto.IPost): PostProto.Post;
         ...
         * @returns Writer
         */
        public static encode(message: PostProto.IPost, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: PostProto.IPost, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): PostProto.Post;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): PostProto.Post;
         ...
         * @returns Post
         */
        public static fromObject(object: { [k: string]: any }): PostProto.Post;
         ...
         * @returns Plain object
         */
        public static toObject(message: PostProto.Post, options?: $protobuf.IConversionOptions): { [k: string]: any };
